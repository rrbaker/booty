<div id="content">
	...
	<div class="row">
		<div id="tooltip-box" class="span12">
	...
	<div class="row">
		<div id="col-reports" class="span8">
			<?php echo $report_listing_view; ?>
		</div> <!-- end #reports-box -->
		
		<div id="col-filters" class="span4">
			...
			<div id="filters-buttons">
				<p>
					<a href="#" class="btn" id="reset_all_filters"><?php echo Kohana::lang('ui_main.reset_all_filters'); ?></a> 
					<a href="#" id="applyFilters" class="btn btn-primary"><?php echo Kohana::lang('ui_main.filter_reports'); ?></a>
				</p>
			</div>
		</div> <!-- end #filters-box -->
	</div>
